...
#foreach ($clusterinst in get-cluster oy_eidos_staging)
...
$mailsubject = "News UK Virtual Infrastructure - vCenter: Newsroom - Annotations Check - $date"
...
$VMInventory | export-csv Nrm_vm_Annotation_Inv.csv -NoTypeInformation

disconnect-viserver newsroomvc5.ni.ad.newsint -force:$true -confirm:$false
