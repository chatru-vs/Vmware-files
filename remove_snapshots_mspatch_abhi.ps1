...
foreach($vm in(cat D:\vcadmin\scripts\vmwpcli\MS_Patch_Snapshots\list_remove.txt))
{

get-snapshot -vm  $vm -Name MSPatch_Snapshot | remove-snapshot -confirm:$false
}
...
$mailsubject = "Windows Patching VM Snapshot Deleted"
$mailcontent = "Snapshots related to Patching have been deleted for the VMs specified"
