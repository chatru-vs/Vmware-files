...
#foreach ($clusterinst in get-cluster pg_test_dev_cluster)
...
$mailsubject = "News UK Virtual Infrastructure - vCenter: PG vCenter - Annotations Check - $date"
...
$VMInventory | export-csv pg_vm_Annotation_Inv.csv -NoTypeInformation

disconnect-viserver pnipgvivcm01.ni.ad.newsint -force:$true -confirm:$false
