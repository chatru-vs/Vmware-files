...
if($vDrive -ne "S:\" -and $vDrive -ne "T:\" -and $vDrive -ne "U:\" -and $vDrive -ne "V:\" )
{
$MyReport += @"
...
Drive S:, T:, U:, V: ignored for free space checks.
...
#$mailto = "IOWindows@newsint.co.uk,iodatacentreteam@newsint.co.uk,brendan.fowler@news.co.uk,lalit.sharma@newsint.co.uk"
$mailto = "vijayarengan.ramachandran@newsint.co.uk,jaspreet.gulati@newsint.co.uk"
